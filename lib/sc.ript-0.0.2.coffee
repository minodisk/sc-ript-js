...
@sc.ript.display.DisplayObject = do ->
...
@sc.ript.display.GraphicsPathCommand = do ->
...
@sc.ript.filter.ThresholdFilter = do ->
...
@sc.ript.filter.KernelFilter = do ->
...
@sc.ript.filter.GaussianBlurFilter = do ->
...
@sc.ript.filter.BilateralFilter = do ->
...
@sc.ript.filter.ColorMatrixFilter = do ->
