(function() {
  var BirateralFilter, Bitmap, Blend, BlendMode, Button, ByteArray, CapsStyle, Color, DLoader, DisplayObject, Event, EventEmitter, Filter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, RGB, Rectangle, Type, k, path, v, _ref,
    __slice = [].slice,
  ...
  Blend = (function() {
    ...
    Blend.punch = function(dr, dg, db, da, sr, sg, sb, sa) {
      return [dr, dg, db, da * Blend._peg(0xff - sa) / 0xff];
    };
  ...
  Filter = (function() {
    ...
    Filter.prototype.run = function(imageData) {
      var data, height, i, p, pixels, width, x, y, _i, _j, _k, _results;
  ...
  KernelFilter = (function(_super) {
    ...
    KernelFilter.prototype._runKernel = function(pixel, pixels, x, y, width, height) {
      ...
      i = 0;
      _results = [];
      for (relY = _i = _ref = -this._radiusY + 1, _ref1 = this._radiusY; _i < _ref1; relY = _i += 1) {
        absY = y + relY;
        _results.push((function() {
          var _j, _ref2, _ref3, _results1;

          _results1 = [];
          for (relX = _j = _ref2 = -this._radiusX + 1, _ref3 = this._radiusX; _j < _ref3; relX = _j += 1) {
            absX = x + relX;
    ...
    KernelFilter.prototype._getPixel = function(pixels, x, y, width, height) {
  ...
  BirateralFilter = (function(_super) {
    __extends(BirateralFilter, _super);

    function BirateralFilter(radiusX, radiusY, kernel) {
      BirateralFilter.__super__.constructor.call(this, radiusX, radiusY, kernel);
    }

    return BirateralFilter;
