(function() {
  var Bitmap, Button, ByteArray, CapsStyle, ColorUtil, DLoader, Event, EventEmitter, GraphicsPathCommand, JointStyle, NumberUtil, Point, Rectangle, Type, k, path, v, _ref,
    __slice = [].slice,
