(function() {
  var BilateralFilter, Bitmap, Blend, BlendMode, BlurFilter, Button, ByteArray, CapsStyle, Color, ColorMatrixFilter, DLoader, DisplayObject, Event, EventEmitter, Filter, GaussianBlurFilter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, QueryString, RGB, Rectangle, StringUtil, ThresholdFilter, Type, k, path, v, _ref,
    __slice = [].slice,
  ...
  Blend = (function() {
    ...
    Blend.punch = (function() {
      if (/Android/.test(navigator.userAgent)) {
        return function(dr, dg, db, da, sr, sg, sb, sa) {
          return [dr, dg, db, (da * Blend._peg(0xff - sa) / 0xff >> 0) > 0xf0 ? 0xff : 0];
        };
      } else {
        return function(dr, dg, db, da, sr, sg, sb, sa) {
    ...
    Blend.mask = (function() {
      if (/Android/.test(navigator.userAgent)) {
        return function(dr, dg, db, da, sr, sg, sb, sa) {
          return [dr, dg, db, da * sa / 0xff > 0xf0 ? 0xff : 0];
        };
      } else {
        return function(dr, dg, db, da, sr, sg, sb, sa) {
  ...
  GaussianBlurFilter = (function(_super) {
  ...
  BilateralFilter = (function(_super) {
  ...
  ColorMatrixFilter = (function(_super) {
