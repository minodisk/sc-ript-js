(function() {
  var Bitmap, Blend, BlendMode, Button, ByteArray, CapsStyle, Color, DLoader, DisplayObject, Event, EventEmitter, Filter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, RGB, Rectangle, Type, k, path, v, _ref,
    __slice = [].slice,
