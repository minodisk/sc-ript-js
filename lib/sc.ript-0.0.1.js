(function() {
  var Bitmap, Button, ByteArray, DLoader, Event, EventEmitter, NumberUtil, Point, Rectangle, k, path, v, _ref,
    __slice = [].slice,
  ...
  Bitmap = (function() {
    ...
    Bitmap.prototype.draw = function(image, matrix) {
      if (matrix != null) {
        this.context.setTransform(matrix.m11, matrix.m12, matrix.m21, matrix.m22, matrix.tx, matrix.ty);
      }
