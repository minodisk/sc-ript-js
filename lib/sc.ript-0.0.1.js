(function() {
  ...
  BirateralFilter = (function(_super) {
    ...
    BirateralFilter._SIGMA_8BIT = 2.04045;

    function BirateralFilter(radiusX, radiusY, threshold) {
    ...
    BirateralFilter.prototype._runKernel = function(pixel, pixels, x, y, width, height) {
