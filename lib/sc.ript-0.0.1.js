(function() {
  var BilateralFilter, Bitmap, Blend, BlendMode, BlurFilter, Button, ByteArray, CapsStyle, Color, ColorMatrixFilter, DLoader, DisplayObject, Event, EventEmitter, Filter, GaussianBlurFilter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, QueryString, RGB, Rectangle, ThresholdFilter, Type, k, path, v, _ref,
    __slice = [].slice,
