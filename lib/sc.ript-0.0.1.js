(function() {
  var BirateralFilter, Bitmap, Blend, BlendMode, BlurFilter, Button, ByteArray, CapsStyle, Color, DLoader, DisplayObject, Event, EventEmitter, Filter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, QueryString, RGB, Rectangle, ThresholdFilter, Type, k, path, v, _ref,
    __slice = [].slice,
  ...
  KernelFilter = (function(_super) {
    ...
    function KernelFilter(radiusX, radiusY, kernel, quality) {
  ...
  BlurFilter = (function(_super) {
    ...
    function BlurFilter(radiusX, radiusY, quality) {
      ...
      BlurFilter.__super__.constructor.call(this, radiusX, radiusY, kernel, quality);
    }
