(function() {
  var Bitmap, Button, ByteArray, CapsStyle, ColorUtil, DLoader, Event, EventEmitter, GraphicsPathCommand, JointStyle, NumberUtil, Point, Rectangle, k, path, v, _ref,
    __slice = [].slice,
  ...
  Bitmap = (function() {
    ...
    function Bitmap(canvas) {
      ...
      console.log('lineStyle:', this._context.strokeStyle);
      console.log('fillStyle:', this._context.fillStyle);
    }
    ...
    Bitmap.prototype.encodeAsPNG = function() {
      return ByteArray.fromDataURL(this._canvas.toDataURL('image/png'));
    };
    ...
    Bitmap.prototype.encodeAsJPG = function(quality) {
      ...
      return ByteArray.fromDataURL(this._canvas.toDataURL('image/jpeg', quality));
    };
    ...
    Bitmap.prototype.lineStyle = function(thickness, color, alpha, capsStyle, jointStyle, miterLimit) {
      ...
      this._context.strokeStyle = ColorUtil.toCSSString(color, alpha);
    ...
    Bitmap.prototype.beginFill = function(color, alpha) {
      ...
      this._context.fillStyle = ColorUtil.toCSSString(color, alpha);
  ...
  ColorUtil = (function() {
    ...
    ColorUtil.toCSSString = function(color, alpha) {
      var b, g, r;
