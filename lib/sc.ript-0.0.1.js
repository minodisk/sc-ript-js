(function() {
  var Bitmap, Blend, BlendMode, Button, ByteArray, CapsStyle, Color, DLoader, DisplayObject, Event, EventEmitter, Filter, GraphicsPathCommand, HSV, JointStyle, Matrix, NumberUtil, Point, RGB, Rectangle, Type, k, path, v, _ref,
    __slice = [].slice,
  ...
  Filter = (function() {
    ...
    Filter.prototype.scan = function(source, rect) {};
  ...
  Bitmap = (function(_super) {
    ...
    Bitmap.prototype.getPixel32 = function(x, y) {
      var a, b, g, imageData, r, _ref;

      imageData = this._context.getImageData(x, y, 1, 1);
      _ref = imageData.data, r = _ref[0], g = _ref[1], b = _ref[2], a = _ref[3];
      return a << 24 | r << 16 | g << 8 | b;
    };

    Bitmap.prototype.getPixel = function(x, y) {
      var b, g, imageData, r, _ref;

      imageData = this._context.getImageData(x, y, 1, 1);
      _ref = imageData.data, r = _ref[0], g = _ref[1], b = _ref[2];
      return r << 16 | g << 8 | b;
    };
