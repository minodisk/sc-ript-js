(function() {
  var BirateralFilter, Bitmap, Blend, BlendMode, BlurFilter, Button, ByteArray, CapsStyle, Color, DLoader, DisplayObject, Event, EventEmitter, Filter, GraphicsPathCommand, HSV, JointStyle, KernelFilter, Matrix, NumberUtil, Point, RGB, Rectangle, ThresholdFilter, Type, k, path, v, _ref,
    __slice = [].slice,
