(function() {
  ...
  if ((typeof module !== "undefined" && module !== null ? module.exports : void 0) != null) {
    if ((_base = module.exports).sc == null) {
      _base.sc = {};
    }
  ...
  sc.ript.util.ArrayUtil = (function() {
    var slice;
  ...
  sc.ript.util.Iterator = (function() {
    ...
    Iterator.count = function(len, callback, step, context) {
      var i;
      if (step == null) {
        step = 1;
      }
      ...
      if (step > 0) {
        i = 0;
        while (i < len) {
          if (callback.call(context, i) === false) {
            return;
          }
          i += step;
        }
  ...
  sc.ript.util.NumberUtil = (function() {
    ...
    NumberUtil.digitAt = function(num, digit) {
      var char, decimal, integer, _ref;
      _ref = ("" + num).split('.'), integer = _ref[0], decimal = _ref[1];
      if (digit < 0) {
        if (decimal == null) {
          decimal = '';
        }
  ...
  sc.ript.util.Path = (function() {
    var splitPath, splitPathRe;
    ...
    splitPath = function(filename) {
      return splitPathRe.exec(filename).splice(1);
    };
    ...
    Path.dirname = function(path) {
      var dir, root, _ref;
      _ref = splitPath(path), root = _ref[0], dir = _ref[1];
    ...
    Path.basename = function(path, ext) {
      var f, _ref;
      _ref = splitPath(path), _ref[0], _ref[1], f = _ref[2];
  ...
  sc.ript.util.StringUtil = (function() {
    ...
    StringUtil.padLeft = function(str, len, pad) {
      str = '' + str;
    ...
    StringUtil.padRight = function(str, len, pad) {
      str = '' + str;
      while (str.length < len) {
        str += pad;
      }
  ...
  sc.ript.util.URL = (function() {
    ...
    URL.parse = function(url) {
      var hash, host, hostname, href, i, origin, pathname, port, protocol, r, search, v, _i, _len;
      ...
      href = r[0], origin = r[1], protocol = r[2], host = r[3], hostname = r[4], port = r[5], pathname = r[6], search = r[7], hash = r[8];
      return {
        href: href,
        origin: origin,
        protocol: protocol,
