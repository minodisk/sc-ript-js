(function() {
  ...
  sc.ript.jquery.Preloader = (function(_super) {
    var Event, Type;

    __extends(Preloader, _super);

    Event = sc.ript.event.Event;
    ...
    Preloader.prototype.addElement = function(el) {
      var e, _i, _len, _ref;

      _ref = $(el);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        e = _ref[_i];
        this.urls.push.apply(this.urls, this._findURLs(e));
      }
      return this;
    };

    Preloader.prototype.addURL = function(url) {
      this.urls.push(url);
      return this;
    };

    Preloader.prototype.load = function() {
      var loaded, total, url, _i, _len, _ref,
        _this = this;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        $('<img>').attr('src', url).on('load error', function() {
          _this.emit(new Event('progress', {
            loaded: ++loaded,
            total: total
          }));
          if (loaded === total) {
            return _this.emit(new Event('complete'));
          }
        });
      }
      return this;
    ...
    Preloader.prototype._findURLs = function(el) {
      var urls, _i, _len, _ref;

      urls = [];
      this._findURL(el, urls);
      _ref = $(el).find('*');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
        this._findURL(el, urls);
    ...
    Preloader.prototype._findURL = function(el, urls) {
      var url, _ref;

      if (el.nodeName === 'IMG' && ((url = $(el).attr('src')) != null)) {
        urls.push(url);
      }
      if ((url = $(el).css('background-image')) !== 'none') {
        _ref = url.match(/url\((.*)\)/), _ref[0], url = _ref[1];
        if (url != null) {
  ...
  sc.ript.ui.Anchor = (function(_super) {
    __extends(Anchor, _super);

    Anchor.prototype.name = 'Anchor';

    function Anchor(el, _arg) {
      this.duration = _arg.duration, this.easing = _arg.easing;
      this._clicked = __bind(this._clicked, this);
      Anchor.__super__.constructor.call(this, el);
      this.el.on('click', this._clicked);
    }
    ...
    Anchor.prototype._clicked = function(e) {
      ...
      if (href.charAt(0) !== "#" || !$.scrollTo(href, this.duration, this.easing)) {
        return;
      }
  ...
  })(sc.ript.ui.UserInterface);

  sc.ript.ui.Button = (function(_super) {
  ...
  sc.ript.ui.UserInterface = (function(_super) {
    __extends(UserInterface, _super);

    function UserInterface(el) {
      console.log(this.name, this);
      this.el = $(el).data(this.name, this);
    }
